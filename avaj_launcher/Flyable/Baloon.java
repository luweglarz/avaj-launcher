...
public class Baloon extends Aircraft{
	...
	public void updateConditions(){
		...
		if (currentWeather.equals("SUN")){
			...
			System.out.println(this.classes[classes.length - 1] + "#" + this.name + "(" + id + ")" + ": Let's enjoy the good weather and take some pics.");
		}
			...
			if ((this.coordinates.getHeight() - 5) <= 0){
				...
				System.out.println(this.classes[classes.length - 1] + "#" + this.name + "(" + id + ")" + ": Landing at: " + this.coordinates.getLongitude() + "," + this.coordinates.getLatitude());
				this.unregisterTower();
			}
			else{
				this.coordinates = new Coordinates(this.coordinates.getLongitude(), this.coordinates.getLatitude(), this.coordinates.getHeight() - 5);
				System.out.println(this.classes[classes.length - 1] + "#" + this.name + "(" + id + ")" + ": Damn you rain! You messed up my baloon.");
			}
		}
			...
			if ((this.coordinates.getHeight() - 3) <= 0){
				...
				System.out.println(this.classes[classes.length - 1] + "#" + this.name + "(" + id + ")" + ": Damn you fog!");
			}
		}
			...
			if ((this.coordinates.getHeight() - 15) <= 0){
				...
				System.out.println(this.classes[classes.length - 1] + "#" + this.name + "(" + id + ")" + ": It's snowing. We're gonna crash.");
			}
		}
	}
