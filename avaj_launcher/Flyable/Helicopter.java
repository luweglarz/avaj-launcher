...
public class Helicopter extends Aircraft{
	...
	public void updateConditions(){
		...
		if (currentWeather.equals("SUN")){
			...
			System.out.println(classes[classes.length - 1] + "#" + this.name + "(" + this.id + ")" + ": Damn you rain! You messed up my rotor.");
		}
			...
			if ((this.coordinates.getHeight() - 12) <= 0){
				...
				System.out.println(classes[classes.length - 1] + "#" + this.name + "(" + this.id + ")" + ": My rotor is going to freeze!");
			}
		}
	}
}
